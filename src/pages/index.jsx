    ...
    >
      ...
      <div className="mt-6 flex">
        ...
        <Button
          className="w-full"
          onClick={() => {
            window.open('mailto:salimtlemcaniportfolio@gmail.com')
          }}
        >
          Email Me
        </Button>
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        ...
        onClick={
          // The email should be sent from the user's email address
          // The email should have a subject of "CV Request"
          // The email should have a body of "Hi, I would like to request a copy of your CV. Thanks"
          // The email should be sent to salimtlemcaniportfolio@gmail.com
          () => {
            window.open(
              "mailto:salimtlemcaniportfolio@gmail.com?subject=CV Request&body=** ADD REASON FOR CV REQUEST AND DON'T FORGET TO SIGN PLEASE**Hi, I would like to request a copy of your CV. Thanks"
            )
          }
        }
      >
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Salim Tlemcani - Electrical and Electronics, Software and Financial
          Engineer
        </title>
        <meta
          name="description"
          content="I’m Salim, a Financial Engineering student based in London. I'm interested in the convergence of finance and technology, and how it can be used to solve real-world problems in emerging markets."
        />
      </Head>
